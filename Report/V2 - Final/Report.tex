...
Problem:
	...
	\end{figure}
		...
		Consequentemente, é invocada a classe relativa ao tipo de problema de \textit{supervised learning} escolhido, em que se obtem os modelos e os parâmetros que se quer testar.

		Após obter todos os algoritmos a serem testados, é invocada, para cada algoritmo, a otimização de parâmetros através da classe \texttt{Model},
		sendo que após ser realizada esta otimização, é possivel obter o melhor modelo com base na métrica definida.
