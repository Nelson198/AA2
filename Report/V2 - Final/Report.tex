...
\large{
	...
	\begin{table}[H] 
		\begin{center}
			\begin{tabular}{>{\centering}p{0.1\textwidth}>{\centering}p{0.13\textwidth}>{\centering}p{0.18\textwidth}>{\centering}p{0.22\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}}
				\toprule \textbf{\textit{Dataset}} & \textbf{Desempenho mínimo esperado} & \textbf{Melhor resultado previsto} & \textbf{Resultado obtido} & \textbf{Melhor modelo} \\
				\midrule \textsl{Pima Indians Diabetes} & 65\% & 77\% & 80.5\% (\textit{accuracy} 76.5\%) & \textit{Gaussian Naive Bayes} \\
				\midrule \textsl{Sonar} & 53\% & 88\% & 83\% (\textit{accuracy} 96.6\%) & \textit{KNN} \\
				\midrule \textsl{Banknote} & 50\% & ----- & 97.8\% (\textit{accuracy} 98\%) & \textit{Logistic Regression} \\
				\midrule \textsl{Iris Flowers} & 26\% & ----- & 93.3\% (\textit{accuracy} 98.7\%) & \textit{Decision Tree Classifier} \\
				\midrule \textsl{Abalone} & 16\% & ----- & 27.5\% (\textit{accuracy} 28.4\%) & \textit{Kernel Support Vector Machine} \\
				\midrule \textsl{Ionosphere} & 64\% & 94\% & 93.3\% (\textit{accuracy} 98.7\%) & \textit{Decision Tree Classifier} \\
				\midrule \textsl{Wheat Seeds} & 28\% & ----- & 95.2\% (\textit{accuracy} 91.4\%) & \textit{Neural Network} \\
